...
class libnative_KType extends ffi.Opaque {}

class libnative_kref_kotlin_Byte extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

typedef libnative_KNativePtr = ffi.Pointer<ffi.Void>;

class libnative_kref_kotlin_Short extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_Int extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_Long extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_Float extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_Double extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_Char extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_Boolean extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_Unit extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_UByte extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_UShort extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_UInt extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_kref_kotlin_ULong extends ffi.Struct {
  external libnative_KNativePtr pinned;
}

class libnative_ExportedSymbols extends ffi.Struct {
  external ffi
          .Pointer<ffi.NativeFunction<ffi.Void Function(libnative_KNativePtr)>>
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          ffi.Bool Function(
              libnative_KNativePtr, ffi.Pointer<libnative_KType>)>> IsInstance;
...
class UnnamedStruct2 extends ffi.Struct {
  external UnnamedStruct3 example;
}

class UnnamedStruct3 extends ffi.Struct {
  external ffi.Pointer<
          ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(libnative_KDouble)>>
      myBestFunction;
}
